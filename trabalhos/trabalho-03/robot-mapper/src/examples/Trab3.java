...
//			while (!Button.ENTER.isUp()) {}
	...
	static int[][] worldMapped = WorldMapResource.getWorldResource("Cenario.txt");
	
	static Point roboticPosition = new Point(5, 3);
	static Point destination = new Point(0, 1);
	...
	public static void main(String args[]) throws InterruptedException {
		...
		robotic.discover(worldMapped, destination);
	}
}
